...
summary_prompt_template = ChatPromptTemplate.from_messages([
    ("human", "Given the information {information} about a person I want you to create:"),
    ("assistant", "1. A short summary"),
    ("assistant", "2. two interesting facts about them")
])
